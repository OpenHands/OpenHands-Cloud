# -----------------------------------------------------------------------------
# Single Cluster - Path-Based Routing Environment
# -----------------------------------------------------------------------------
...
# URL path prefixes (e.g., domain.com/api/, domain.com/runtime/).
# -----------------------------------------------------------------------------
...
terraform {
  ...
  #   prefix = "openhands/single-cluster-path"
  # }
}
...
# Wildcard record for subdomains (if needed for auth, etc.)
